...
const displayCard = (pokemon) => {
  ...
  pokemonCard.classList.add("flex", "bg-white", "min-w-100", "m-2", "rounded-xl", "shadow-sm");
  ...
  pokemonInfo.classList.add("mb-6");
  pokemonInfo.textContent = `ID : ${pokemon.id} | Name : ${pokemon.name} type : ${pokemon.type}`;

  const button = document.createElement("button");
  button.classList.add("self-start", "ml-auto", "mt-2", "mr-2", "bg-red-300", "p-2", "rounded-lg", "hover:bg-red-500", "duration-200");
